...
int Prim(int start_vertice = 5) {
	...
	//WARNING!!! IF VERTICES STARTING FROM 0,MUST BE V,IF FROM 1 THEN V-1
	vector<bool> visited(V + 1, false);

	MST.reserve(V - 1); //WARNING!!! IF VERTICES STARTING FROM 0,MUST BE V,IF FROM 1 THEN V-1
